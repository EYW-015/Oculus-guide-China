...
excerpt: >-
  Instructions on how to customize the main navigation and enabling breadcrumb
  links.
last_modified_at: '2018-03-20T19:59:40.000Z'
toc: true
---
...
!\[priority plus masthead animation\]\(\)
...
See the \[**sidebars** documentation\]\(\) for information on setting up a custom navigation menu.
