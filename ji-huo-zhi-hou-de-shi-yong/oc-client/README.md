...
于是就需要开启[**Clash的TUN模式**](../../quest-guide/udp-hotspot/clash-tun.md)给OC客户端联网，~~或用到**Proxifier**进行应用代理~~（已不推荐）

{% content-ref url="../../quest-guide/udp-hotspot/clash-tun.md" %}
[clash-tun.md](../../quest-guide/udp-hotspot/clash-tun.md)
{% endcontent-ref %}
